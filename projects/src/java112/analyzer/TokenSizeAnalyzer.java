...
public class TokenSizeAnalyzer implements Analyzer {
    ...
    /**
     *Default constructor. Instantiates the map of  token  sizes<br>
     *
     */
    ...
    public int getMaximumSize() {
    	...
    	try {
            maxEntry = Collections.max(tokenSizes.entrySet(),new Comparator<Map.Entry<Integer, Integer>>(){
    ...
    public int getAsterisksValue() {        
        ...
        return  this.getMaximumSize() /maxAsterisks;
    }
